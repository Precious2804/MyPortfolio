  ...
  <main id="main">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Twitter:</strong> <a href="https://twitter.com/presh_dev">https://twitter.com/presh_dev</a></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Redux <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Portfolio</h2>
          <p>Listed below are some of my major Developments</p>
        </div>
        ...
        <div>
          <div class="row" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 portfolio-item filter-app">
              ...
              <div>
                <h5 class="text-primary">Nextropay</h5>
                <p>Nextropay is an organisation providing cryptocurrency payment services and personal wallets. We enable customers to operate worldwide, decrease costs and reach new markets whilst using our reliable cryptocurrency processing services and the wallet app.</p>
              </div>
            </div>
            <div class="col-lg-4 portfolio-item filter-app">
            ...
            <div class="col-lg-4 portfolio-item filter-app">
              <a href="http://easy-vtu.herokuapp.com/login" target="_blank">
                <div class="portfolio-wrap">
                  <img src="assets/img/easy_Vtu_main_b.png" class="img-fluid" alt="EasyVtu">
                </div>
              </a>
              <div>
                <h5 class="text-primary">EasyVtu</h5>
            ...
            <div class="col-lg-4 portfolio-item filter-app">
              ...
              <div>
                <h5 class="text-primary">Cards & Events</h5>
        ...
        <div class="row mt-1">
          ...
          <div class="col-lg-4">
            <div class="info">
              ...
              <div class="email">
                <a href="mailto:anipreciousebuka@gmail.com">
                  <i class="bi bi-envelope"></i>
                </a>
                <h4>Email:</h4>
                <p><a href="mailto:anipreciousebuka@gmail.com">anipreciousebuka@gmail.com</a></p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call:</h4>
                <p><a href="tel:+234 8176 157 244">+234 8176 157 244</a> or <a href="tel:+234 7012 566 931">+234 7012 566 931</a></p>
              </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="social-links">
        ...
        <a href="https://www.linkedin.com/in/precious-ebuka-aa4718180/" target="_blank" class="linkedin"><i class="bx bxl-linkedin"></i></a>
      ...
      <div class="credits">
        Designed by <a href="{{route('/')}}">Presh</a>
      </div>
    </div>
  </footer><!-- End Footer -->
