...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>Precious Ani</h1>
      <p>I'm a <span class="typed" data-typed-items="Web Developer, Freelancer, System Analyst, Mobile Developer "></span></p>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About Me</h2>
          <p>My name is Precious Ani, I am Full Stack Web Developer, with fundamental knowledge of PHP, MYSQL, JAVASCRIPT, BOOTSTRAP, HTML and CSS. I am also a skilled Mobile Developer with Flutter, for both Android and IOS devices. I have strong work and learning ethics, which aids the efficiency of my work output, that would definately be useful for You.</p>
        </div>

        <div class="row">
          <div class="col-lg-4">
            <img src="assets/img/presh.jpg" class="img-fluid" alt="">
          </div>
    ...
    <section id="skills" class="skills section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Skills</h2>
          <p>I am skilled in Web Development Programming Languages and Frameworks, and also Intermidately skilled in Mobile Development Languages. Below are my skills and skill strenghts</p>
        </div>
    ...
    <section id="resume" class="resume">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Resume</h2>
          <p>Here is My Resume, containing my skills, certificates, achievements etcetera.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0">
              <h4>Precious Ani</h4>
              <p><em>An Innovative and Efficiency-Driven Web Developer with 4+ years of experience in designing and developing Real-life Website Applicatiosn to solve Real-life problems.</em></p>
              <ul>
                <li>Enugu, Nigeria</li>
                <li>(123) 456-7891</li>
            ...
            <div class="resume-item">
              ...
              <h5>2015 - 2019</h5>
              <p><em>University of Nigeria, Nsukka</em></p>
          ...
          <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-4 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <img src="assets/img/portfolio/buxiscrow.png" class="img-fluid" alt="Buxiscrow" height="100%" width="100%">
              </div>
              <div>
            ...
            <div class="col-lg-4 col-md-4 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <img src="assets/img/portfolio/buxipay.png" class="img-fluid" alt="Buxipay" height="100%" width="100%">
              </div>
              <div>
            ...
            <div class="col-lg-4 col-md-4 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <img src="assets/img/Constropal_logo.png" class="img-fluid" alt="Constropal" height="100%" width="100%">
              </div>
              <div>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>With a vast acquistion of tech knowlegde in the Software Development World, I can be boasful of been able to render the following services, with a promise of timely delivery and great efficiency that you would enjoy as a client</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <p>With impeccable and flexible skills in development of web applications, you can be rest assured that your website is in the best hands for development. And most importantly, a guarantee for timely and effective delivery.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              ...
              <p>As a result of my flexibility in the world of programming and an excessive interest for tech, I can also boast of handling a perfect build up for that Mobile Application that is useful for both Android and IOS devices. And also, with a timely and efficient delivery</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <p>My Expertise also cover very many of other varieties of tech, like in Graphics designing, Tutoring, System Analysis and performance evaluation, etc.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Abakpa Nike, Enugu. Nigeria</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>anipreciousebuka@gmail.com</p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call:</h4>
                <p>+234 8176 157 244 or +234 7012 566 931</p>
              </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="www.preshdev.com">Presh</a>
      </div>
    </div>
  </footer><!-- End Footer -->
